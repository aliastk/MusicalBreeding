...
(function(root, factory) {
  ...
  p5.Element.prototype._translate = function() {
    ...
    if (arguments.length === 2) {
      this.elt.style.transform = 'translate(' + arguments[0] + 'px, ' +
        arguments[1] + 'px)';
    } else if (arguments.length > 2) {
      this.elt.style.transform = 'translate3d(' + arguments[0] + 'px,' +
        arguments[1] + 'px,' + arguments[2] + 'px)';
  ...
  p5.Element.prototype.style = function(prop, val) {
    ...
    if (val instanceof p5.Color) {
      val = 'rgba(' + val.levels[0] + ',' + val.levels[1] + ',' + val.levels[
        2] + ',' + val.levels[3] / 255 + ')'
    }
    ...
    if (typeof val === 'undefined') {
      ...
      if (prop === 'rotate' || prop === 'translate' || prop ===
        'position') {
        ...
        if (prop === 'width' || prop === 'height' || prop === 'left' ||
          prop === 'top') {
    ...
    if (arguments.length === 0) {
      ...
      if (aW !== AUTO || aH !== AUTO) {
        ...
        if (this.elt instanceof HTMLCanvasElement) {
          ...
          this.elt.setAttribute('style', 'width:' + aW + 'px; height:' +
            aH + 'px');
  ...
  p5.MediaElement = function(elt, pInst) {
    ...
    Object.defineProperty(self, 'src', {
      get: function() {
        ...
        var srcVal = self.elt.src === window.location.href ? '' :
          self.elt.src;
        var ret = firstChildSrc === window.location.href ? srcVal :
          firstChildSrc;
        return ret;
      },
  ...
  p5.MediaElement.prototype.loadPixels = function() {
    ...
    if (this.loadedmetadata) { // wait for metadata for w/h
      ...
      this.drawingContext.drawImage(this.elt, 0, 0, this.canvas.width,
        this.canvas.height);
